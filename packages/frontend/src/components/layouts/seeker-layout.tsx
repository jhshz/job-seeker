...
const navItems: { to: string; label: string; Icon: IconType }[] = [
  { to: "/seeker/dashboard", label: "داشبورد", Icon: HiOutlineChartBar },
  { to: "/seeker/applications", label: "درخواست‌های من", Icon: HiOutlineClipboardDocumentList },
  { to: "/seeker/resumes", label: "رزومه‌های من", Icon: HiOutlineDocumentText },
  { to: "/seeker/resume-wizard", label: "ساخت رزومه", Icon: HiOutlinePlus },
  { to: "/seeker/profile", label: "پروفایل و تنظیمات", Icon: HiOutlineUser },
];
...
export function SeekerLayout() {
  ...
  const isActive = (path: string) => {
    ...
    if (path === "/seeker/dashboard") {
      return pathname === "/seeker/dashboard" || pathname === "/seeker";
    }
